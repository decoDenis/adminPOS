...
INSERT INTO `cajas` VALUES (1,'23','Caja miraflores',1,1,'2020-12-14 18:27:08',0),(2,'12','CAJA CENTRO',14,1,'2020-12-14 18:29:13',0);
...
INSERT INTO `respaldos` VALUES (1,'respaldo_sistema_20-01-2021_08_AM_37.sql',26,'2021-01-20 08:37:47'),(2,'respaldo_sistema_20-01-2021_09_04_AM.sql',26,'2021-01-21 00:14:59');
...
CREATE TABLE `temporal_compra` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 COMMENT='Almacenar compras temporal sin grabar.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-01-21  0:15:01
